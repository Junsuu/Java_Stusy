...
public class MaleStudentExample_22 {
	public static void main(String[] args) {
		List<StudentEnum> list = Arrays.asList(
				...
				MaleStudent maleStudent = list.stream().filter(s -> s.getSex() == Sex.MALE).collect(MaleStudent :: new, MaleStudent :: accmulate, MaleStudent :: combine);
